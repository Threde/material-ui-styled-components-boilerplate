...
var TestComponent = function (_a) {
    var theme = _a.theme;
    return (React__default.createElement(Div, { theme: theme },
        React__default.createElement(H4, { variant: 'h4' }, "Typography"),
        React__default.createElement(H5, { variant: 'h5' }, "Material-UI h5"),
        React__default.createElement(H6, { variant: 'h6' }, "i am a Material-UI h6 "),
        React__default.createElement(Subtitle1, { variant: "subtitle1" }, "i am a Material-UI subtitle 1"),
        React__default.createElement(Body1, { variant: 'body1' }, "i am a Materia-UI body 1"),
        React__default.createElement(Caption, { variant: "caption" }, "caption text Materia-UI"),
        React__default.createElement(Overline, { variant: "overline" }, "overline text Materia-UI")));
};
...
var ButtonComponent = function (_a) {
    ...
    return (React__default.createElement(StyledButton, __assign({ size: size, primary: primary, style: { backgroundColor: backgroundColor } }, props), label));
};
var templateObject_1;

export { ButtonComponent, TestComponent };
